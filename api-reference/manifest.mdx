...
| `projects[].env`            | object   | Masked values ("**\*\*\*\***") are ignored on apply. Map of string values. |
...
| `projects[].env`            | object   | No       | Masked values ("**\*\*\*\***") are ignored on apply. Map of string values. |
...
| `actions[].resource` | string   | One of: `project`, `env`, `domain`, `storage`, `queue`.                |
