...
| `projects[].databases[].backup.copyRegions` | string[] | Reserved for regional backup-copy execution; must remain empty. |
...
| `projects[].databases[].backup.copyRegions` | string[] | No | Reserved for regional backup-copy execution; must remain empty. |
