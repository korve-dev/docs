...
| `projects[].speedInsights` | object | Privacy-first real-user performance policy. Omit to leave it unmanaged. |
| `projects[].speedInsights.enabled` | boolean | — |
| `projects[].speedInsights.sampleRate` | number | — |
| `projects[].speedInsights.allowedOrigins` | string[] | — |
...
| `projects[].speedInsights` | object | No | Privacy-first real-user performance policy. Omit to leave it unmanaged. |
| `projects[].speedInsights.enabled` | boolean | Yes | — |
| `projects[].speedInsights.sampleRate` | number | No | — |
| `projects[].speedInsights.allowedOrigins` | string[] | No | — |
...
| `actions[].resource` | string | One of: `project`, `git`, `env`, `environment`, `domain`, `storage`, `queue`, `cron`, `realtime`, `ai-gateway`, `alert`, `access`, `auth`, `speed-insights`, `maintenance`, `customer-payments`. |
...
| `plan.actions[].resource` | string | One of: `project`, `git`, `env`, `environment`, `domain`, `storage`, `queue`, `cron`, `realtime`, `ai-gateway`, `alert`, `access`, `auth`, `speed-insights`, `maintenance`, `customer-payments`. |
