...
| `bucket`       | string         | —                                                                                                                                                                                                      |
| `prefix`       | string         | Optional repository prefix using ASCII letters, digits, dot, underscore, slash, or hyphen. It cannot begin with a slash or contain two consecutive dots. Pattern: `^(?!/)(?!.*\.\.)[A-Za-z0-9._/-]*$`. |
...
| `bucket`                      | string         | Yes      | —                                                                                                                                                                                                      |
| `prefix`                      | string         | No       | Optional repository prefix using ASCII letters, digits, dot, underscore, slash, or hyphen. It cannot begin with a slash or contain two consecutive dots. Pattern: `^(?!/)(?!.*\.\.)[A-Za-z0-9._/-]*$`. |
