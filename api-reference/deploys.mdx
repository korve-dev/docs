...
| `422`  | Invalid sourceKey, gitRepo, gitRef, or environment — including deploys addressed to the preview environment or repositories outside this organization's installation. |
