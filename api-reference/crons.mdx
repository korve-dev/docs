...
| `responseStatus`            | integer or null                                        | —                                                                                                                                                                                                              |
| `error`                     | string or null                                         | —                                                                                                                                                                                                              |
| `responseBody`              | object or array or string or number or boolean or null | Bounded target response body retained for inspection as parsed JSON, sanitized text, or null when unavailable. Secret-like JSON fields are redacted and provider-specific infrastructure terms are normalized. |
| `responseBodyTruncated`     | boolean                                                | Whether the retained response body exceeded the 32,768-byte limit or could not be read completely.                                                                                                             |
