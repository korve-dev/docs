...
| `422`  | Invalid name, slug, repository settings, or repository access. A repository installed for another organization is never accepted. |
...
| `404`  | No such project in this organization.                           |
| `422`  | Invalid project or repository settings, or no fields to update. |
| `502`  | Repository access could not be verified — try again.            |
