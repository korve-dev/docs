...
| `422`  | Invalid name, slug, or runtime class. |
...
| `latestDeployment.trigger.kind`            | string         | push = a push to a connected branch, pr = a pull-request preview, manual = the API/CLI. One of: `push`, `pr`, `manual`.                 |
