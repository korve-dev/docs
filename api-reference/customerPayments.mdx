...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments" \
...
```bash
curl -X PUT "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments" \
  -b "$SESSION" \
...
```bash
curl -X DELETE "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments" \
  -b "$SESSION"
```
...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/products?cursor=example" \
  -H "Authorization: Bearer korve_..."
```
...
```bash
curl -X POST "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/products" \
  -H "Authorization: Bearer korve_..." \
  -H "Content-Type: application/json" \
  -d '{
  "name": "Storefront"
...
```bash
curl -X PATCH "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/products/$PRODUCT_ID" \
  -H "Authorization: Bearer korve_..." \
  -H "Content-Type: application/json" \
  -d '{
  "name": "Storefront"
...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/prices?cursor=example" \
  -H "Authorization: Bearer korve_..."
```
...
```bash
curl -X POST "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/prices" \
  -H "Authorization: Bearer korve_..." \
  -H "Content-Type: application/json" \
  -d '{
  "productId": "example",
...
```bash
curl -X DELETE "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/prices/$PRICE_ID" \
  -H "Authorization: Bearer korve_..."
```
...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/customers?cursor=example" \
  -H "Authorization: Bearer korve_..."
```
...
```bash
curl -X POST "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/customers" \
  -H "Authorization: Bearer korve_..." \
  -H "Content-Type: application/json" \
  -d '{
  "email": "dev@acme.com"
...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/checkouts?cursor=example" \
  -H "Authorization: Bearer korve_..."
```
...
```bash
curl -X POST "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/checkouts" \
  -H "Authorization: Bearer korve_..." \
  -H "Content-Type: application/json" \
  -d '{
  "priceId": "example",
...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/subscriptions?cursor=example" \
  -H "Authorization: Bearer korve_..."
```
...
```bash
curl -X POST "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/subscriptions/$SUBSCRIPTION_ID/cancel" \
  -H "Authorization: Bearer korve_..." \
  -H "Content-Type: application/json" \
  -d '{
  "atPeriodEnd": true
...
```bash
curl "https://api.korve.dev/v1/orgs/$ORG_ID/projects/$PROJECT_ID/payments/events?cursor=example" \
  -H "Authorization: Bearer korve_..."
```
...
| `items[].id`               | string         | Format: `uuid`.                           |
| `items[].type`             | string         | —                                         |
| `items[].processingStatus` | string         | One of: `processed`, `ignored`, `failed`. |
