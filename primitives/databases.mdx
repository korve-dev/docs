...
- **Coming:** direct connections from `scale-to-zero` apps. Until then,
  scale-to-zero projects should reach their data through an API layer or
  an always-on companion project.
