...
[Deploys API](/api-reference/deploys). MCP calls the same operation through
`korve.request` after discovering it with `search`.
...
error, the service configuration, recent deployment history (flaky vs
