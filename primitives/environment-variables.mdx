...
Per-project environment variables are **encrypted at rest** and injected
into your app's environment on the next deploy. Keys follow the usual
shape: `^[A-Z][A-Z0-9_]{0,63}$`.
