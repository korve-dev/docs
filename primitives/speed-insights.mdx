...
The example uses the version 1 manifest compatibility contract. Its `runtimeClass` field is required
only because that old contract must round-trip existing projects. New project creation does not ask
you to select a runtime class.
